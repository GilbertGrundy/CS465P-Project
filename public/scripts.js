...
function loadRaceTotals() {
  ...
  xhr.onreadystatechange = function () {
    ...
    if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
      ...
      name.className = "name";
      xc.className = "venue";
      road.className = "venue";
      outdoor.className = "venue";
      indoor.className = "venue";
      trail.className = "venue";
      totals.className = "venue";
      xc.innerHTML = "XC";
      road.innerHTML = "Road";
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        if (i === data.length - 1 || data[i].name !== data[i + 1].name) {
          ...
          tempCell1.className = "venue";
          tempCell2.className = "venue";
          tempCell3.className = "venue";
          tempCell4.className = "venue";
          tempCell5.className = "venue";
          tempCell6.className = "venue";
